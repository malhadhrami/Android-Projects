...
public class p2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private Item[] mItems = {
            new Item("Type 1","fully Vaccinated\nPassport\nFood Tray\nNail cutter along with litter sands", R.drawable.p2_1),
            new Item("Type 2","Litter trained\nMicrochipped\nPassport\nPlayful", R.drawable.p2),
            new Item("Type 3","AMale play cat\nfully vaccinated\npassport chip\nneutered vet check", R.drawable.p2_2)
    };
        ...
        bottomAppBar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.home) {
                    Toast.makeText(p2.this, " Home Page ", Toast.LENGTH_SHORT).show();
