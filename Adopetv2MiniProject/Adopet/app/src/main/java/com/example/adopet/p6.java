...
public class p6 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private Item[] mItems = {
            new Item("Type 1", "3 Years old\nPlayful\nVaccinated\nPassport", R.drawable.p6),
            new Item("Type 2", "2 Years old\nVaccinated\nMicroshipped\nPassport", R.drawable.p6_1),
            new Item("Type 3", "2 Months\nVaccinated\nMicroshipped\nPassport", R.drawable.p6_2)
    };
        ...
        bottomAppBar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.home) {
                    Toast.makeText(p6.this, " Home Page ", Toast.LENGTH_SHORT).show();
    ...
    public void exit() {
        new AlertDialog.Builder(p6.this)
