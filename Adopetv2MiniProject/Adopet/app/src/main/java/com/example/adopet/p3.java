...
public class p3 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private Item[] mItems = {
            new Item("Type 1","Male play cat\nfully vaccinated\npassport chip\nneutered vet check", R.drawable.p3),
            new Item("Type 2","Litter trained\nMicrochipped\nPassport\nPlayful", R.drawable.p3_1),
            new Item("Type 3","2 year old very friendly Polar Bear", R.drawable.p3_2)
    };
        ...
        bottomAppBar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.home) {
                    Toast.makeText(p3.this, " Home Page ", Toast.LENGTH_SHORT).show();
    ...
    public void exit() {
        new AlertDialog.Builder(p3.this)
